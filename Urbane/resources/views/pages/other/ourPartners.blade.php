...
@section('body')
    <div class="flex flex-col items-center min-h-screen  px-8 relative">
        ...
        <div class="flex flex-col-reverse md:flex-row items-center  justify-center gap-8">
            <iframe class="w-full h-full" src="https://www.youtube.com/watch?v=VsTY-kyp2Js" frameborder="0" allowfullscreen></iframe>
            <div class="max-w-[700px] w-full">
                <p class="regular-16 md:regular-24 lg:regular-28 text-black md:text-white">At Urbane, we believe that working with a partner is a long-term commitment. A voyage made possible by everyone's participation. A journey that needs us all to question everything we do and how we do it in order to always grow and progress. That is the path we have walked since 2023.</p>
            </div>
            
        </div>
        <div class="relative w-[100vw] h-[80px] sm:h-[160px] lg:h-[200px] mt-4">
