...
<div class="sidebar active fixed md:relative flex w-[300px] h-screen bg-gradient-to-r from-primary to-emerald-600 duration-500 py-4 overflow-hidden rounded-e-[40px] z-50">
